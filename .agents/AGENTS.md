...
- **DEPENDENCY & SUPPLY CHAIN VIGILANCE**: Verify third-party packages and dependencies before installation. Avoid adding unverified or unnecessary global executable dependencies.
